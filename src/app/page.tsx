    ...
    <main className="bg-grey15">
      ...
      <section className="container mx-auto bg-grey15">
        ...
        <ul className="container mx-auto flex flex-col lg:flex-row ">
          <ServicesCard img="images/ServicesDesign.png" title="Design" description="At Squareup, our design team is passionate about creating stunning, 
          ...
          <ServicesCard img="images/ServicesEngineering.png" title="Engineering" description="Our engineering team combines technical expertise 
          ...
          <ServicesCard img="images/ServicesManagement.png" title="Project Management" description="Our experienced project management team ensures that your projects are delivered on time, within budget, 
